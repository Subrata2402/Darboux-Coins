...
from HQApi.exceptions import ApiResponseError, BannedIPError, NotAuthenticatedError
...
class BaseHQApi:
    ...
    async def store(self):
        """
        Get HQ Trivia store details.
        response_data = {'groupedPlacements': 
                            {'buyBackInBundle': [{'description': 'Buy an Extra Life '
                                                                   'and get 100 bonus '
                                                                   'Coins!',
                                                    'itemType': 'extra-life',
                                                    'name': 'Stay in the game!',
                                                    'products': [{'accentColor': '#F7D555',
                                                                  'backgroundColor': '#ECEBF0',
                                                                  'highlighted': False,
                                                                  'label': None,
                                                                  'sku': 'com.intermedia.store.bundle.coins.100.el.1'}]}],
                            'buyBackInItem': [{'description': '',
                                          'itemType': 'extra-life',
                                          'name': 'Buy an Extra Life to stay '
                                                  'in the game!',
                                          'products': [{'accentColor': '#F7D555',
                                                        'backgroundColor': '#ECEBF0',
                                                        'highlighted': False,
                                                        'label': None,
                                                        'sku': 'com.intermedia.hq.item.extralife.1x'}]}],
                            'storefront': [{'ctaText': 'Learn more',
                                       'ctaUrl': 'https://hqtrivia.com/legal/faq.html',
                                       'description': 'Wrong answer? Continue '
                                                      'playing with an extra '
                                                      'life.',
                                       'itemType': 'extra-life',
                                       'name': 'Extra Lives',
                                       'products': [{'accentColor': None,
                                                     'backgroundColor': '#ECEBF0',
                                                     'highlighted': False,
                                                     'label': None,
                                                     'sku': 'com.intermedia.hq.item.extralife.1x'},
                                                    {'accentColor': None,
                                                     ...
                                                     'highlighted': False,
                                                     'label': None,
                                                     'sku': 'com.intermedia.hq.item.extralife.3x'},
                                                    {'accentColor': None,
                                                     'backgroundColor': '#ECEBF0',
                                                     'highlighted': False,
                                                     'label': None,
                                                     'sku': 'com.intermedia.hq.item.extralife.5x'}]},
                                      {'description': 'Use an Eraser to '
                                                      'eliminate one wrong '
                                                      'answer during a '
                                                      'question.',
                                       'itemType': 'eraser',                                       'name': 'Erasers',
                                       'products': [{'accentColor': None,
                                                     'backgroundColor': '#ECEBF0',
                                                     'highlighted': False,
                                                     'label': None,
                                                     'sku': 'com.intermedia.hq.item.erasers.1x'},
                                                    {'accentColor': None,
                                                     'backgroundColor': '#ECEBF0',
                                                     'highlighted': False,
                                                     'label': None,
                                                     'sku': 'com.intermedia.hq.item.erasers.3x'},
                                                    {'accentColor': None,
                                                     'backgroundColor': '#ECEBF0',
                                                     'highlighted': False,
                                                     'label': None,
                                                     'sku': 'com.intermedia.hq.item.erasers.5x'}]},
                                      {'description': 'Get more coins to buy '
                                                      'Power Ups!',
                                       'itemType': 'coins',
                                       'name': 'Coins',
                                       'productIds': ['com.intermedia.store.coins.500',
                                                      'com.intermedia.store.coins.1750',
                                                      'com.intermedia.store.coins.3000',
                                                      'com.intermedia.store.coins.6500',
                                                      'com.intermedia.store.coins.10000',
                                                      'com.intermedia.store.coins.15000']}]},
                        'itemTypes': {'10x-pts-multi': {'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/items/pointmultiplier@3x.png',
                                                        'namePlural': '10x Point Multipliers',
                                                        'nameSingular': '10x Point Multiplier'},
                        '15x-pts-multi': {'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/items/pointmultiplier@3x.png',
                                        'namePlural': '15x Point Multipliers',
                                        'nameSingular': '15x Point Multiplier'},
                        '5x-pts-multi': {'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/items/pointmultiplier@3x.png',
                                'namePlural': '5x Point Multipliers',
                                'nameSingular': '5x Point Multiplier'},
                        'eraser': {'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/items/eraser@3x.png',
                                'namePlural': 'Erasers',
                                'nameSingular': 'Eraser'},
                        'extra-life': {'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/items/extralife@3x.png',
                              'namePlural': 'Extra Lives',
                              'nameSingular': 'Extra Life'},               'offair-10x-pts-multi': {'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/items/pointmultiplier@3x.png',
                                        'namePlural': '10x Offair Points '
                                                      'Multipliers',
                                        'nameSingular': '10x Offair Points '
                                                        'Multiplier'},
                        'offair-unlock': {'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/items/unlock@3x.png',
                                 'namePlural': 'Game Unlocks',
                                 'nameSingular': 'Game Unlock'}},
                        'placements': {'endGameMultipliers': [{'accentColor': None,                                        'backgroundColor': '#ECEBF0',
                                        'highlighted': False,
                                        'label': None,
                                        'sku': 'com.intermedia.hq.item.multiplier.5x'},
                                       {'accentColor': None,                                        'backgroundColor': '#ECEBF0',
                                        'highlighted': False,
                                        'label': None,
                                        'sku': 'com.intermedia.hq.item.multiplier.10x'},
                                       {'accentColor': None,                                        'backgroundColor': '#ECEBF0',
                                        'highlighted': False,
                                        'label': None,
                                        'sku': 'com.intermedia.hq.item.multiplier.15x'}],
                        'needCoins': [{'description': '',
                               'itemType': 'coins',
                               'name': 'You need more Coins to buy that Power '
                                       'Up',
                               'productIds': ['com.intermedia.store.coins.500',
                                              'com.intermedia.store.coins.1750',
                                              'com.intermedia.store.coins.3000']}],
                        'offairTriviaBundles': [{'description': '',
                                         'itemType': None,
                                         'name': 'Boosts',
                                         'productIds': ['com.intermedia.hq.item.bundles.offair.1a',
                                                        'com.intermedia.hq.item.bundles.offair.2a',
                                                        'com.intermedia.hq.item.bundles.offair.3a']}],
                        'offairTriviaItems': [{'accentColor': None,
                                               'backgroundColor': '#ECEBF0',
                                               'highlighted': False,                                       'label': None,
                                               'sku': 'com.intermedia.hq.item.offair.unlock.1x'}],
                        'proTicketsIngame': [],
                        'triviaIngame': [{'accentColor': None,
                                          'backgroundColor': '#ECEBF0',
                                          'highlighted': False,
                                          'label': None,
                                          'sku': 'com.intermedia.hq.item.extralife.1x'},
                                         ...
                                         {'accentColor': None,
                                          ...
                                          'label': None,
                                          'sku': 'com.intermedia.hq.item.erasers.5x'}]},
                        'products': {'iap': [{'coinValue': 500,
                               'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/coin@3x.png',
                               'name': '500 Coins',
                               'sku': 'com.intermedia.store.coins.500'},
                              {'coinValue': 1500,
                               'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/coin@3x.png',
                               'name': '1,500 Coins',
                               'sku': 'com.intermedia.store.coins.1500'},
                              {'coinValue': 1750,
                               'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/coin@3x.png',
                               'name': '1,750 Coins',
                               'sku': 'com.intermedia.store.coins.1750'},
                              {'coinValue': 3000,
                               'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/coin@3x.png',
                               'name': '3,000 Coins',
                               'sku': 'com.intermedia.store.coins.3000'},
                              {'coinValue': 5000,
                               'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/coin@3x.png',
                               'name': '5,000 Coins',
                               'sku': 'com.intermedia.store.coins.5000'},
                              {'coinValue': 6500,
                               'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/coin@3x.png',
                               'name': '6,500 Coins',
                               'sku': 'com.intermedia.store.coins.6500'},
                              {'coinValue': 10000,
                               'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/coin@3x.png',
                               'name': '10,000 Coins',
                               'sku': 'com.intermedia.store.coins.10000'},
                              {'coinValue': 15000,
                               'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/coin@3x.png',
                               'name': '15,000 Coins',
                               'sku': 'com.intermedia.store.coins.15000'},
                              {'coinValue': 100,
                               'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/bundle-el1-coins100-free.png',
                               'name': '1 Extra Life and 100 Coins',                       'sku': 'com.intermedia.store.bundle.coins.100.el.1'},
                              {'coinValue': 100,
                               'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/bundle-el3-coins100-free.png',
                               'name': '3 Extra Lives and 100 Coins',
                               'sku': 'com.intermedia.store.bundle.coins.100.el.3'},
                              {'coinValue': 100,
                               'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/bundle-el5-coins100-free.png',
                               'name': '5 Extra Lives and 100 Coins',
                               'sku': 'com.intermedia.store.bundle.coins.100.el.5'}],
                      'items': [{'awards': [{'itemType': 'extra-life', 'quantity': 1}],
                                 'coinPrice': 400,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/el-1.png',
                                 'name': 'Extra Lives',
                                 'sku': 'com.intermedia.hq.item.extralife.1x'},
                                {'awards': [{'itemType': 'extra-life', 'quantity': 3}],
                                 'coinPrice': 1000,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/el-3.png',
                                 'name': '3 Extra Lives',
                                 'sku': 'com.intermedia.hq.item.extralife.3x'},
                                {'awards': [{'itemType': 'extra-life', 'quantity': 5}],
                                 'coinPrice': 1500,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/el-5.png',
                                 'name': '5 Extra Lives',
                                 'sku': 'com.intermedia.hq.item.extralife.5x'},
                                {'awards': [{'itemType': 'eraser', 'quantity': 1}],
                                 'coinPrice': 100,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/eraser-1.png',
                                 'name': '1 Eraser',
                                 'sku': 'com.intermedia.hq.item.erasers.1x'},
                                {'awards': [{'itemType': 'eraser', 'quantity': 3}],
                                 'coinPrice': 250,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/eraser-3.png',
                                 'name': '3 Erasers',
                                 'sku': 'com.intermedia.hq.item.erasers.3x'},
                                {'awards': [{'itemType': 'eraser', 'quantity': 5}],
                                 'coinPrice': 400,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/eraser-5.png',
                                 'name': '5 Erasers',
                                 'sku': 'com.intermedia.hq.item.erasers.5x'},
                                {'awards': [{'itemType': '5x-pts-multi',
                                             'quantity': 1}],
                                 'coinPrice': 400,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/multiplier-5.png',
                                 'name': '5x Point Multiplier',
                                 'sku': 'com.intermedia.hq.item.multiplier.5x'},
                                {'awards': [{'itemType': '10x-pts-multi',
                                             'quantity': 1}],
                                 'coinPrice': 650,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/multiplier-10.png',
                                 'name': '10x Point Multiplier',
                                 'sku': 'com.intermedia.hq.item.multiplier.10x'},
                                {'awards': [{'itemType': '15x-pts-multi',
                                             'quantity': 1}],
                                 'coinPrice': 900,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/multiplier-15.png',
                                 'name': '15x Point Multiplier',
                                 'sku': 'com.intermedia.hq.item.multiplier.15x'},
                                {'awards': [{'itemType': 'offair-unlock',
                                             'quantity': 1}],
                                 'coinPrice': 100,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/offair-unlock.png',
                                 'name': '1 Game Unlock',
                                 'sku': 'com.intermedia.hq.item.offair.unlock.1x'},
                                {'awards': [{'itemType': 'offair-10x-pts-multi',
                                             'quantity': 1}],
                                 'coinPrice': 1000,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/multiplier-15.png',
                                 'name': 'Daily Challenge Multiplier',
                                 'sku': 'com.intermedia.hq.item.bundles.offair.1a'},
                                {'awards': [{'itemType': 'offair-10x-pts-multi',
                                             'quantity': 1},
                                            {'itemType': 'offair-unlock',
                                             'quantity': 3},
                                            {'itemType': 'extra-life', 'quantity': 3}],
                                 'coinPrice': 1700,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/multiplier-15.png',
                                 'name': 'HQ Bundle',
                                 'sku': 'com.intermedia.hq.item.bundles.offair.2a'},
                                {'awards': [{'itemType': 'offair-10x-pts-multi',
                                             'quantity': 1},
                                            {'itemType': 'offair-unlock',
                                             'quantity': 5},
                                            {'itemType': 'extra-life', 'quantity': 3},
                                            {'itemType': 'eraser', 'quantity': 10}],
                                 'coinPrice': 2000,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/multiplier-15.png',
                                 'name': 'Mega Bundle',
                                 'sku': 'com.intermedia.hq.item.bundles.offair.3a'},
                                {'awards': [{'itemType': 'heart-boost', 'quantity': 1}],
                                 'coinPrice': 500,
                                 'iconUrl': 'https://prd-bucket-hqtrivia-01012022.nyc3.cdn.digitaloceanspaces.com/static/store/products/heart-boost.png',
                                 'name': 'Boost',
                                 'sku': 'com.intermedia.hq.heart.item.boost'}]}}
        """
...
class HQApi(BaseHQApi):
    def __init__(self, token: str = None, login_token: str = None,
                 version: str = "1.7.7", host: str = "https://api-quiz.hype.space/",
        ...
        self.headers = {
            ...
            "x-hq-client": "iOS/" + self.hq_version
        }
        if login_token:
