...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        page1.add_field(name=f"{ctx.prefix}glogin (response url)", value="> Add your HQ Trivia account in bot with Google response url.")
        ...
        page1.set_footer(text=f"Page : 01/05 | Total Commands : 08", icon_url=ctx.author.avatar_url)
